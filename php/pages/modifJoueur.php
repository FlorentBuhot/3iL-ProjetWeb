    ...
    <div class="container mt-5">
        ...
        <form action="/php/controllers/modifierJoueur.php" method="post">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="nom" name="nom" value="<?php echo $_REQUEST['nom']?>">
            </div>

            <div class="form-group">
                <label for="prenom">Prénom :</label>
                <input type="text" class="form-control" id="prenom" name="prenom" value="<?php echo $_REQUEST['prenom']?>">
            </div>

            <div class="form-group">
                <label for="nb_match">Nombre de match :</label>
                <input type="number" class="form-control" id="nb_match" name="nb_match" min="0" value="<?php echo $_REQUEST['nb_match']?>">
            </div>

            <div class="form-group">
                <label for="nb_buts">Nombre de buts total :</label>
                <input type="number" class="form-control" id="nb_buts" name="nb_buts" min="0" value="<?php echo $_REQUEST['nb_buts']?>">
            </div>
