...
if ($id_equipe_1 == $id_equipe_2) {
    header("Location:pageModifMatch?id_match=$id_match&nom_match=$nom_match&date_match=$date_match&heure_match=$heure_match&description_match=$description_match&id_equipe_1=$id_equipe_1&id_equipe_2=$id_equipe_2&msg=Les équipes doivent être différentes");
    exit();
}
...
try {
    ...
    header("Location:pageModifMatch?id_match=$id_match&nom_match=$nom_match&date_match=$date_match&heure_match=$heure_match&description_match=$description_match&id_equipe_1=$id_equipe_1&id_equipe_2=$id_equipe_2&msg=Erreur avec la base de données");
    exit();
}

// Redirection vers une page de confirmation
header("Location:organisateur?confirmModifMatch=true");
exit();
